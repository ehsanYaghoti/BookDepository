        ...
        return (
            ...
            <div className='home-dashboard'>
                ...
                <div className='dashborad-body'>
                    <h2 className='dashborad-body-title'>افزودن دسته بندی جدید</h2>
                        {   
                            this.state.loading 
                            ? 
                            ...
                            : 
                                ...
                                <form onSubmit={formHandler} className='formContainer' style={{alignItems : 'center' ,  whiteSpace: 'nowrap'}}>
                                    <label>نام دسته :
                                    ...
                                    <label>دسته والد :
                                    <select className='selector' value={this.state.category.parent} onChange={inputHandler} name='parent' style={{ width: '250px'}} >
