                        ...
                        {   
                            ...
                            : 
                                ...
                                <>
                                    ...
                                    <FormBook editMode={true} categories={this.state.categories} statementHandler={statementHandler} book={this.state.book} inputHandler={inputHandler} formHandler={formHandler} imageHandler={imageHandler}  selectHandler={selectHandler}/>
                                </>                                
                                :
                                this.state.result 
                                ?
